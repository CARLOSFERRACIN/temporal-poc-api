...
namespace Temporal.POC.ExternalDomain.Api.Extensions;
...
public static class ServiceExtensions
{
    public static IServiceCollection AddTemporalServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services
            ...
            .AddWorkflow<ExternalDomainWorkflow>();
    ...
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "Temporal POC External Domain API",
                Version = "v1",
                Description = "API Externa que chama TransactionWorkflow via Nexus"
            });
        });
